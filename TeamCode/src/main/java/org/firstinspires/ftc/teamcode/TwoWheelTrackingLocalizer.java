...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Intake")); //THis encoder is plugged into the same port as the Intake
        ...
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "ArmBase"));  //This encoder is plugged into the same port as the ARMBASE DC power cables
